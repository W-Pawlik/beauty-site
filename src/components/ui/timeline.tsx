      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        {data.map((item, index) => (
          <div
            ...
            className="flex justify-start gap-0 pt-10 md:gap-10 md:pt-32"
          >
            <div className="sticky top-40 z-30 flex w-full max-w-xs self-start md:flex-row md:items-center lg:max-w-sm">
              <div className="absolute left-3 flex h-10 w-10 items-center justify-center rounded-full bg-white shadow-[0_0_0_1px_rgba(73,65,63,0.08)]">
            ...
            <div className="relative w-full pl-20 pr-4 md:pl-4">
              <h3 className="mb-4 block text-2xl font-semibold tracking-[0.08em] text-[#8c7a84] md:hidden">
                {item.title}
              </h3>
              {item.content}
            </div>
